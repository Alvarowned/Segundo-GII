...
CREATE TABLE public."Compra_Entrada"(
	...
	"Opinión" smallint CHECK ("Opinión" >= 0 AND "Opinión" <= 10),
	CONSTRAINT "Usuario_compra_Entrada_pk" PRIMARY KEY ("Código_entrada_Entrada")
